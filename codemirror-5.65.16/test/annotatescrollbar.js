...
(function () {
  ...
  var simpleProg = "function foo() {/n/n  return /"foo/";/n/n}/n/nfoo();/n";
  var consecutiveLineMatches = "function foo() {/n  return /"foo/";/n}/nfoo();/n";
  var singleLineMatches = "function foo() { return /"foo/"; }foo();/n";
